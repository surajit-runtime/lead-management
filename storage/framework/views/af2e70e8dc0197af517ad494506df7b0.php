                                ...
                                <div class="auth-content my-auto">
                                    ...
                                    <?php if(\Session::has('error')): ?>
                                        <div class="alert alert-danger alert-dismissible alert-label-icon label-arrow fade show"
                                            role="alert">
                                            <i
                                                class="mdi mdi-block-helper label-icon"></i><strong><?php echo e(\Session::get('error')); ?></strong>
                                            <button type="button" class="btn-close" data-bs-dismiss="alert"
                                                aria-label="Close"></button>
                                        </div>
                                    <?php elseif(\Session::has('sendotpsuccess')): ?>
                                        <div class="card-body">
                                            <div class="alert alert-success alert-dismissible alert-label-icon label-arrow fade show"
                                                role="alert">
                                                <i
                                                    class="mdi mdi-check-all label-icon"></i><strong><?php echo e(\Session::get('sendotpsuccess')); ?></strong>
                                                <button type="button" class="btn-close" data-bs-dismiss="alert"
                                                    aria-label="Close"></button>
                                            </div>
                                        </div>
                                    <?php elseif(\Session::has('successotp')): ?>
                                        <div class="card-body">
                                            <div class="alert alert-success alert-dismissible alert-label-icon label-arrow fade show"
                                                role="alert">
                                                <i
                                                    class="mdi mdi-check-all label-icon"></i><strong><?php echo e(\Session::get('successotp')); ?></strong>
                                                <button type="button" class="btn-close" data-bs-dismiss="alert"
                                                    aria-label="Close"></button>
                                            </div>
                                        </div>
                                    ...
                                    <form class="mt-4" action="<?php echo e(route('generateOTP')); ?>" method="post"
                                        id="emailForm">
                                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <form class="mt-4" action="<?php echo e(route('otpverify')); ?>" method="post"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <form class="mt-4" action="<?php echo e(route('updatpass')); ?>" method="post"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mt-5 text-center">
                                        <p class="text-muted mb-0">Remember It ? <a href="<?php echo e(route('index')); ?>"
...
<?php /**PATH C:\Runtime\Lead Management Project files\Lead management\resources\views/frontend/auth-recoverpw.blade.php ENDPATH**/ ?>