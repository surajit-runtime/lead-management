                    ...
                    <div class="w-100">
                        <div class="d-flex flex-column h-100">
                            <div class="mb-4 mb-md-5 text-center">
                                <a href="<?php echo e(route('index')); ?>" class="d-block auth-logo">
                            ...
                            <div class="auth-content my-auto">
                                ...
                                <?php elseif(\Session::has('successChangepass')): ?>
                                <div class="card-body">
                                    <div class="alert alert-success alert-dismissible alert-label-icon label-arrow fade show" role="alert">
                                        <i class="mdi mdi-check-all label-icon"></i><strong><?php echo e(\Session::get('successChangepass')); ?></strong>
                                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                    </div>
                                </div>
                                <?php elseif(\Session::has('OTPlogin')): ?>
                                <div class="card-body">
                                    <div class="alert alert-success alert-dismissible alert-label-icon label-arrow fade show" role="alert">
                                        <i class="mdi mdi-check-all label-icon"></i><strong><?php echo e(\Session::get('OTPlogin')); ?></strong>
                                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                    </div>
                                </div>
                                ...
                                <form class="custom-form mt-4 pt-2" action="<?php echo e(route('checklogin')); ?>" method="post" id="loginForm">
                                    <?php echo csrf_field(); ?>
                                    <div class="mb-3">
                                        <label class="form-label" for="username">Username</label>
                                        <input type="text" class="form-control" id="username" placeholder="Enter username" name="username" value="<?php echo e(old('username', Cache::get('email', ''))); ?>"autocomplete="off">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 ">
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div class="flex-shrink-0">
                                                <div class="">
                                                    <a href="<?php echo e(route('reset_pass')); ?>" class="text-muted">Forgot password?</a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="input-group auth-pass-inputgroup">
                                            <input type="password" class="form-control" placeholder="Enter password" name="password" value="<?php echo e(old('password', Cache::get('password', ''))); ?>" aria-label="Password" aria-describedby="password-addon" autocomplete="off">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 captcha">
                                        <span><?php echo App\Http\Controllers\LoginController::generateCaptcha(config('captcha.default.type')); ?></span>
                                ...
                                <form class="mt-4" action="<?php echo e(route('loginOtpVerfiy')); ?>" method="post" id="otpForm" style="display: none" >

                                    <?php echo csrf_field(); ?>
                                    
                                    <div class="mb-3 "> 
                                        <input type="hidden" name="hidden_email" value="<?php echo e(Session::get('email')); ?>">
...
</html><?php /**PATH C:\Runtime\Lead Management Project files\Lead management\resources\views/frontend/login.blade.php ENDPATH**/ ?>