                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Dead Leads</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Leads</a></li>
                                            <li class="breadcrumb-item active">Dead Leads</li>
                                        </ol>
                                    </div>
                                ...
                                <div class="card">
                                 ...
                                 <div class="card-body">
                                    ...
                                    <div style="display: flex;align-items: flex-end;height: 83px; ">
                                        ...
                                        <div>
                                            <strong style="display: block; font-size: 24px;">{{ $dead_lead_count }}</strong>
