...
@endphp --}}
                ...
                <div class="row">
                    ...
                    @elseif($lead_details_nurturing->lead_state->state_name == "No State" || $lead_details_nurturing->lead_district->city == "No District")
                              ...
                              <div>
                                {{-- <form id="pristine-valid-example" novalidate method=""> --}}
                                    ...
                                    <div class="row">
                                        ...
                                        @if(($lead_details_nurturing->pincode != 0) && (isset($BM_dist->distributor_name)))
                                        <!-- Your code here -->
                ...
                <div class="col-xl-6 col-md-6"  id="DistributorDiv"> <!-- Change the column width to 6 to have two fields in a row -->
                    <div class="form-group mb-3">
                        <label>Distributor Name<sup style="color:red;">*</sup></label>
                ...
                <div class="col-xl-6 col-md-6" id="DistributorDivEmail"> <!-- Change the column width to 6 to have two fields in a row -->
                    <div class="form-group mb-3">
                        <label>BM Email<sup style="color:red;">*</sup></label>
                ...
                <div class="col-xl-6 col-md-6" id="DistributorDivMobile"> <!-- Change the column width to 6 to have two fields in a row -->
                    <div class="form-group mb-3">
                        <label>BM Mobile Number<sup style="color:red;">*</sup></label>
                    ...
                    {{-- <input type="hidden" name="executive_id_assign_to" value="">
                                        ...
                                        <div class="col-xl-6 col-md-6" id="SalesDiv"> <!-- Change the column width to 6 to have two fields in a row -->
                                            <div class="form-group mb-3">
                                                <label for="BM">Distributor Name<sup style="color:red;">*</sup></label>
                                        ...
                                        <div class="col-xl-6 col-md-6" id="DistributorDiv"> <!-- Change the column width to 6 to have two fields in a row -->
                                            <div class="form-group mb-3">
                                                <label>BM Name<sup style="color:red;">*</sup></label>
                                                <input type="text" id="distributor_name" required data-pristine-required-message="Please Enter BM Name" class="form-control" placeholder="BM Name"  value="" name="executive_id_assign_to" disabled />
                                        ...
                                        <div class="col-xl-6 col-md-6" id="DistributorDivEmail"> <!-- Change the column width to 6 to have two fields in a row -->
                                            <div class="form-group mb-3">
                                                <label>BM Email<sup style="color:red;">*</sup></label>
                                                <input type="text" id="distributor_email" required data-pristine-required-message="Please Enter BM Email" class="form-control" placeholder="BM Email"  value="" name="distributor_email" disabled />
                                        ...
                                        <div class="col-xl-6 col-md-6" id="DistributorDivMobile"> <!-- Change the column width to 6 to have two fields in a row -->
                                            <div class="form-group mb-3">
                                                <label>BM Mobile Number<sup style="color:red;">*</sup></label>
                                                <input type="text" id="distributor_mobile" required data-pristine-required-message="Please Enter BM Mobile Number" class="form-control" placeholder="BM Mobile Number"  value="" name="distributor_mobile" disabled />
                    ...
                    @endif
                                        ...
                                        <div class="col-xl-6 col-md-6" id="ReminderDiv">
                                            <div class="form-group mb-3">
                                                <label for="example-datetime-local-input" class="form-label">Set Date & Time for remainder<sup style="color:red;">*</sup></label>
                                        ...
                                        <div class="col-xl-6 col-md-6"> <!-- Change the column width to 6 to have two fields in a row -->
                                            <div class="form-group mb-3">
                                                ...
                                                <textarea type="text" required data-pristine-required-message="Please Enter a Notes" class="form-control" placeholder="Enter notes" name="lead_data"></textarea>
                                            </div>
                                                 <span class="text-danger">
                                                @error('lead_data')
                                                    {{ $message }}
                                ...
                                <a href="/call_not_received/{{ $lead_details_nurturing->id }}" class="btn btn-secondary" style="margin-left: 5px;">Did not Receive Call</a>
                            </div>
                              </div>
                            </div>
                        </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var Reminder_div = document.getElementById('ReminderDiv');
    Reminder_div.style.display = 'block';  
