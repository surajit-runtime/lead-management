                ...
                <div class="row">
                    <div class="col-12">
                            <div class="alert alert-info alert-dismissible alert-label-icon label-arrow fade show mb-0" role="alert">
                                <i class="mdi mdi-alert-circle-outline label-icon"></i><strong>You have {{ $pending_leads_count }} new Lead(s) assigned, kindly Check it.</strong> 
                        ...
                        <div class="card card-h-100">
                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-6">
                                        ...
                                        <h4 class="mb-3">
                                            <span class="counter-value" data-target="{{ $total_leads }}">0</span>
                                        </h4>
                                    </div>
                                ...
                                <div class="text-nowrap">
                                    {{-- <span class="badge badge-soft-success text-success">+10%</span>
                         ...
                         @php
                            ...
                            foreach ($hot_lead_month_wise_countArray as $count) {
                                $defaultData[$count->month - 1] = $count->count;
                            } 
                            $default_data_nurturing = array_fill(0, 12, 0);
                            foreach ($nurturing_lead_month_wise_count as $count) {
                                $default_data_nurturing[$count->month - 1] = $count->count;
                            } 
                            
                            $default_data_dead = array_fill(0, 12, 0);
                            foreach ($dead_lead_month_wise_countArray as $count) {
                                $default_data_dead[$count->month - 1] = $count->count;
                            } 
                            $default_data_closed = array_fill(0, 12, 0);
                            foreach ($closed_lead_month_wise_countArray as $count) {
                                $default_data_closed[$count->month - 1] = $count->count;
                            } 
                            $default_data_fb = array_fill(0, 12, 0);
                            foreach ($fb_month_wise_countArray as $count) {
                                $default_data_fb[$count->month - 1] = $count->count;
                            } 
                            
                            $default_data_insta = array_fill(0, 12, 0);
                            foreach ($insta_month_wise_countArray as $count) {
                                $default_data_insta[$count->month - 1] = $count->count;
                            } 
                            
                            $default_data_web = array_fill(0, 12, 0);
                            foreach ($web_month_wise_countArray as $count) {
                                $default_data_web[$count->month - 1] = $count->count;
                            } 
                            
                            $default_data_manual = array_fill(0, 12, 0);
                            foreach ($manual_month_wise_countArray as $count) {
                                $default_data_manual[$count->month - 1] = $count->count;
                            } 
                    @endphp
                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-6">
                                        ...
                                        <h4 class="mb-3">
                                            <span class="counter-value" data-target="{{ $hot_leads_count }}">0</span>
                                        </h4>
                                    </div>
                                    <div class="col-6">
                                        <div id="mini-chart2" data-colors='["#5156be"]' class="apex-charts mb-2"></div>
                                        <span class="ms-1 text-muted font-size-8"style="font-size: 11px;">Monthly Data of {{ $currentYear }}</span>
                                    </div>
                                </div>
                                {{-- <div class="text-nowrap">
                                    <span class="badge badge-soft-danger text-danger">20% less Leads</span>
                                    <span class="ms-1 text-muted font-size-13">Since last week</span>
                                </div> --}}
                            </div><!-- end card body -->
                        </div><!-- end card -->
                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-6">
                                        ...
                                        <h4 class="mb-3">
                                            <span class="counter-value" data-target="{{ $nurturing_lead_count }}">0</span>
                                        </h4>
                                    </div>
                                    <div class="col-6">
                                ...
                                {{-- <div class="text-nowrap">
                                    <span class="badge badge-soft-success text-success">+ 2.8%</span>
                                    <span class="ms-1 text-muted font-size-13">Since last week</span>
                                </div> --}}
                            </div><!-- end card body -->
                        </div><!-- end card -->
                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-6">
                                        ...
                                        <h4 class="mb-3">
                                            <span class="counter-value" data-target="{{ $dead_lead_count }}">0</span>
                                        </h4>
                                    </div>
                                    <div class="col-6">
                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-6">
                                        ...
                                        <h4 class="mb-3">
                                            <span class="counter-value" data-target="{{ $closed_lead_count }}">0</span>
                                        </h4>
                                    </div>

                                    <div class="col-6">
                                        <div id="mini-chart16" data-colors='["#5156be"]' class="apex-charts mb-2"></div>
                                        <span class="ms-1 text-muted font-size-8"style="font-size: 11px;">Monthly Data of {{ $currentYear }}</span>
                                    </div>
                                </div>
                                <div class="text-nowrap">
                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-6">
                                        ...
                                        <h4 class="mb-3">
                                            <span class="counter-value" data-target="{{ $pending_leads_count }}">0</span>
                                        </h4>
                                    </div>

                                    <div class="col-6">
                                        {{-- <div id="mini-chart7" data-colors='["#5156be"]' class="apex-charts mb-3"></div> --}}
                                    </div>
                                </div>
                                <div class="text-nowrap">
                                    {{-- <span class="badge badge-soft-success text-success">+10%</span>
                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-6">
                                        ...
                                        <h4 class="mb-3">
                                            <span class="counter-value" data-target="{{ $fb_count }}">0</span>
                                        </h4>
                                    </div>

                                    <div class="col-6">
                                        <div id="mini-chart5" data-colors='["#5156be"]' class="apex-charts mb-3"></div>
                                        <span class="ms-1 text-muted font-size-8"style="font-size: 11px;">Monthly Data of {{ $currentYear }}</span>
                                    </div>
                                </div>
                                <div class="text-nowrap">
                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-6">
                                        ...
                                        <h4 class="mb-3">
                                            <span class="counter-value" data-target="{{ $insta_count }}">0</span>
                                        </h4>
                                    </div>

                                    <div class="col-6">
                                        <div id="mini-chart6" data-colors='["#5156be"]' class="apex-charts mb-3"></div>
                                        <span class="ms-1 text-muted font-size-8"style="font-size: 11px;">Monthly Data of {{ $currentYear }}</span>
                                    </div>
                                </div>
                                <div class="text-nowrap">
                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-6">
                                        ...
                                        <h4 class="mb-3">
                                            <span class="counter-value" data-target="{{ $manual_lead_count }}">0</span>
                                        </h4>
                                    </div>

                                    <div class="col-6">
                                        <div id="mini-chart8" data-colors='["#5156be"]' class="apex-charts mb-3"></div>
                                        <span class="ms-1 text-muted font-size-8"style="font-size: 11px;">Monthly Data of {{ $currentYear }}</span>
                                    </div>
                                </div>
                                <div class="text-nowrap">
                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-6">
                                        ...
                                        <h4 class="mb-3">
                                            <span class="counter-value" data-target="{{ $web_count }}">0</span>
                                        </h4>
                                    </div>
                                            ...
                                            <div class="timeline-list-item">
                                                <div class="d-flex">
                                                    <div class="flex-grow-1 overflow-hidden me-4">
                                                        ...
                                                        <p class="text text-muted font-size-13">0xb77ad0099e21d4fca87fa4ca92dda1a40af9e05d205e53f38bf026196fa2e431</p>
                                                    </div>
...
{{-- wrapper-class closed here , started in header.blade.php --}}
    </div>
    <!-- JAVASCRIPT -->
