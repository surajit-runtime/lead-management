...
// mini-3
@if(isset($default_data_nurturing))
var minichart3Colors = getChartColorsArray("#mini-chart3");
var monthNames = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];

var options = {
    series: [{
        data: {!! json_encode($default_data_nurturing) !!}
    }],
    chart: {
        type: 'line',
        height: 50,
...
@endif
// mini-4
@if(isset($default_data_dead))
var minichart4Colors = getChartColorsArray("#mini-chart4");
var monthNames = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];

var options = {
    series: [{
        data: {!! json_encode($default_data_dead) !!}
    }],
    chart: {
        type: 'line',
        height: 50,
...
@endif
// mini-5
@if(isset($default_data_closed))
var minichart16Colors = getChartColorsArray("#mini-chart16");
var monthNames = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];

var options = {
    series: [{
        data: {!! json_encode($default_data_closed) !!}
    }],
    chart: {
        type: 'line',
        height: 50,
...
@if(isset($default_data_fb))
var minichart5Colors = getChartColorsArray("#mini-chart5");
var monthNames = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];

var options = {
    series: [{
        data: {!! json_encode($default_data_fb) !!}
    }],
    chart: {
        type: 'line',
        height: 50,
...
@endif
// mini-6
@if(isset($default_data_insta))
var minichart6Colors = getChartColorsArray("#mini-chart6");
var monthNames = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];

var options = {
    series: [{
        data: {!! json_encode($default_data_insta) !!}
    }],
    chart: {
        type: 'line',
        height: 50,
...
@if(isset($default_data_web))
var minichart7Colors = getChartColorsArray("#mini-chart7");
var monthNames = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];

var options = {
    series: [{
        data: {!! json_encode($default_data_web) !!}
    }],
    chart: {
        type: 'line',
        height: 50,
...
@if(isset($default_data_manual))
var minichart8Colors = getChartColorsArray("#mini-chart8");
var monthNames = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];

var options = {
    series: [{
        data: {!! json_encode($default_data_manual) !!}
    }],
    chart: {
        type: 'line',
        height: 50,
...
@endif
    ...
    // mini-9
    @if(isset($defaultData_admin))
var minichart9Colors = getChartColorsArray("#mini-chart9");
var monthNames = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];

var options = {
    series: [{
        data: {!! json_encode($defaultData_admin) !!}
    }],
    chart: {
        type: 'line',
        height: 50,
...
// mini-10
@if(isset($default_data_nurturing_admin))
var minichart10Colors = getChartColorsArray("#mini-chart10");
var monthNames = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];

var options = {
    series: [{
        data: {!! json_encode($default_data_nurturing_admin) !!}
    }],
    chart: {
        type: 'line',
        height: 50,
...
@endif
// mini-11
@if(isset($default_data_dead_admin))
var minichart11Colors = getChartColorsArray("#mini-chart11");
var monthNames = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];

var options = {
    series: [{
        data: {!! json_encode($default_data_dead_admin) !!}
    }],
    chart: {
        type: 'line',
        height: 50,
...
@if(isset($default_data_closed_admin))
var minichart18Colors = getChartColorsArray("#mini-chart18");
var monthNames = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];

var options = {
    series: [{
        data: {!! json_encode($default_data_closed_admin) !!}
    }],
    chart: {
        type: 'line',
        height: 50,
...
@if(isset($default_data_fb_admin))
var minichart12Colors = getChartColorsArray("#mini-chart12");
var monthNames = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];

var options = {
    series: [{
        data: {!! json_encode($default_data_fb_admin) !!}
    }],
    chart: {
        type: 'line',
        height: 50,
...
@endif
// mini-13
@if(isset($default_data_insta_admin))
var minichart13Colors = getChartColorsArray("#mini-chart13");
var monthNames = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];

var options = {
    series: [{
        data: {!! json_encode($default_data_insta_admin) !!}
    }],
    chart: {
        type: 'line',
        height: 50,
...
@if(isset($default_data_manual_admin))
var minichart14Colors = getChartColorsArray("#mini-chart14");
var monthNames = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];

var options = {
    series: [{
        data: {!! json_encode($default_data_manual_admin) !!}
    }],
    chart: {
        type: 'line',
        height: 50,
...
@if(isset($default_data_web_admin))
var minichart15Colors = getChartColorsArray("#mini-chart15");
var monthNames = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];

var options = {
    series: [{
        data: {!! json_encode($default_data_web_admin) !!}
    }],
    chart: {
        type: 'line',
        height: 50,
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="text-sm-end d-none d-sm-block">
                    Design & Develop by <a href="#!" class="text-decoration-underline">Huddlers</a>
                </div>
            </div>
        </div>
    </div> --}}
