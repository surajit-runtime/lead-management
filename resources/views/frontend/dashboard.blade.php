                ...
                <div class="row">
                    <div class="col-12">
                            <div class="alert alert-info alert-dismissible alert-label-icon label-arrow fade show mb-0" role="alert">
                                <i class="mdi mdi-alert-circle-outline label-icon"></i><strong>You have {{ $unassigned_count }} new Lead(s) , kindly assign it to the Call centers.</strong> 
                        ...
                        <div class="card card-h-100">
                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-6">
                                        {{-- <span class="text-muted mb-3 lh-1 d-block text">Monthly Data of {{ $currentYear }}</span> --}}
                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-6">
                                        ...
                                        <h4 class="mb-3">
                                            <span class="counter-value" data-target="{{ $unassigned_count }}">0</span>
                                        </h4>
                                    </div>
